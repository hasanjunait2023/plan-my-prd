...
export default function TradeIntelligence() {
  ...
  return (
    <SectionVisibilityProvider pageKey="trade-intelligence">
      <div className="space-y-6 max-w-[1200px] mx-auto">
        ...
        {/* Top Alert */}
        {topSetups.length > 0 && (
          <HideableSection id="top-setups" title="Top Setups Right Now">
        ...
        <Tabs defaultValue="confluence" className="space-y-4">
          ...
          <TabsContent value="confluence">
            <HideableSection id="confluence-grid" title="Confluence Grid">
              {loadingConfluence ? (
          ...
          <TabsContent value="adr">
            <HideableSection id="adr-grid" title="ADR Monitor">
              {loadingAdr ? (
                <div className="flex items-center justify-center py-20">
                  <Loader2 className="w-6 h-6 animate-spin text-primary" />
                </div>
          ...
          <TabsContent value="tools">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <HideableSection id="risk-calculator" title="Risk Calculator">
                <RiskCalculator />
              </HideableSection>
              <HideableSection id="session-tracker" title="Session Tracker">
                <SessionTracker />
              </HideableSection>
            </div>
          </TabsContent>
