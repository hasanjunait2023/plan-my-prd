        ...
        <CardContent className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-muted-foreground">
              BotFather এ bot তৈরি করো → bot কে message পাঠাও → <a href="https://api.telegram.org/bot{TOKEN}/getUpdates" target="_blank" className="text-primary hover:underline">getUpdates</a> দিয়ে chat_id পাও
            </p>
          </div>
          ...
          <div className="space-y-3 pt-2">
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">⚡ EMA Alignment Shift</p>
                <p className="text-xs text-muted-foreground">Multi-timeframe alignment changes</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">🔴 Risk Breach Warning</p>
                <p className="text-xs text-muted-foreground">Daily loss limit ও max trade alerts</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-muted-foreground">London ও NY session open এর আগে alert</p>
              </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm font-medium">📊 MT5 Trade Updates</p>
                <p className="text-xs text-muted-foreground">Trade open/close notifications</p>
              </div>
